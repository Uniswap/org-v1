...
The Uniswap analytics platform — [https://info.uniswap.org](info.uniswap.org) — now tracks v3 performance. You can continue to review [v2 stats](http://v2.info.uniswap.org/) here.
