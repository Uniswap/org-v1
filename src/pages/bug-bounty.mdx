...
<sup>
  *All the contracts here are in scope except example contracts and those within the test folder. Bugs in Periphery
  Contracts will be considered less severe than those found in Uniswap Core.
</sup>
...
<small>
  *Note that this does not include loss of funds on any third party platforms when interacting with Uniswap features,
  e.g. flash swaps.
</small>
