...
`https://v1.uniswap.exchange/swap?theme=dark`
...
`https://v1.uniswap.exchange/send?recipient=0x74Aa01d162E6dC6A657caC857418C403D48E2D77`
...
`https://v1.uniswap.exchange/remove-liquidity?poolTokenAmount=1.23`
...
`https://v1.uniswap.exchange/create-exchange?tokenAddress=0x0F5D2fB29fb7d3CFeE444a200298f468908cC942`
