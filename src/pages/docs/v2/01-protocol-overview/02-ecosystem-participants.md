...
- Finally, some DeFi pioneers are exploring complex liquidity provision interactions like incentivized liquidity, liquidity as collateral, and other experimental strategies. The Uniswap protocol is the perfect protocol for projects to experiment with these kinds of ideas.
...
- DAPP users buy tokens using the Uniswap protocol for use in other applications on Ethereum.

- Smart contracts that execute trades on the protocol by implementing trading functionality (from products like DEX aggregators to custom Solidity scripts).

In all cases, trades are subject to the same flat fee for trading on the protocol. Each is important for increasing the accuracy of prices and incentivizing liquidity.

# Developers/Projects

There are far too many ways the Uniswap protocol is used in the wider Ethereum ecosystem to count, but some examples include:

- The open-source, accessible nature of the Uniswap protocl means there are countless UX experiments and front-ends built to offer access to Uniswap protocol functionality. You can find Uniswap protocol functions in most of the major DeFi dashboard projects. There are also many [Uniswap protocol-specific tools](https://github.com/Uniswap/universe) built by the community.
...
# Uniswap Labs Team and Community

The broader Uniswap community drives the ongoing development of the Uniswap protocol, originally developed by the Uniswap Labs team, and the Uniswap protocol ecosystem.
